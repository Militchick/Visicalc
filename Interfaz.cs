...
namespace Visicalc
{
    ...
    class Interfaz
    {
        ...
        protected void DibujarPantalla()
        {
            ...
            {
                casillaActual = "A" +
                Convert.ToChar('A' + columnaActual - 26) +
                (filaActual + 1);
            }
            else if (columnaActual > 52)
            {
                casillaActual = "B" +
                Convert.ToChar('A' + columnaActual - 52) +
                (filaActual + 1);
            }
            else if (columnaActual > 78)
            {
                casillaActual = "C" +
                Convert.ToChar('A' + columnaActual - 78) +
                (filaActual + 1);
            }
            else if (columnaActual > 104)
            {
                casillaActual = "D" +
                Convert.ToChar('A' + columnaActual - 104) +
                (filaActual + 1);
            }
            else if (columnaActual > 130)
            {
                casillaActual = "E" +
                Convert.ToChar('A' + columnaActual - 130) +
                (filaActual + 1);
            }
            else if (columnaActual > 156)
            {
                casillaActual = "F" +
                Convert.ToChar('A' + columnaActual - 156) +
                (filaActual + 1);
            }
            else if (columnaActual > 182)
            {
                casillaActual = "G" +
                Convert.ToChar('A' + columnaActual - 182) +
                (filaActual + 1);
            }
            else if (columnaActual > 208)
            {
                casillaActual = "H" +
                Convert.ToChar('A' + columnaActual - 208) +
                (filaActual + 1);
            }
            else if (columnaActual > 234)
            {
                casillaActual = "I" +
                Convert.ToChar('A' + columnaActual - 234) +
                (filaActual + 1);
            }
            else if (columnaActual > 260)
            {
                casillaActual = "J" +
                Convert.ToChar('A' + columnaActual - 260) +
                (filaActual + 1);
            }
            else if (columnaActual > 286)
            {
                casillaActual = "K" +
                Convert.ToChar('A' + columnaActual - 286) +
                (filaActual + 1);
            }
            else if (columnaActual > 312)
            {
                casillaActual = "L" +
                Convert.ToChar('A' + columnaActual - 312) +
                (filaActual + 1);
            }
            else if (columnaActual > 338)
            {
                casillaActual = "M" +
                Convert.ToChar('A' + columnaActual - 338) +
                (filaActual + 1);
            }
            else if (columnaActual > 364)
            {
                casillaActual = "N" +
                Convert.ToChar('A' + columnaActual - 364) +
                (filaActual + 1);
            }
            else if (columnaActual > 380)
            {
                casillaActual = "O" +
                Convert.ToChar('A' + columnaActual - 380) +
                (filaActual + 1);
            }
            else if (columnaActual > 406)
            {
                casillaActual = "P" +
                Convert.ToChar('A' + columnaActual - 406) +
                (filaActual + 1);
            }
            else if (columnaActual > 432)
            {
                casillaActual = "Q" +
                Convert.ToChar('A' + columnaActual - 432) +
                (filaActual + 1);
            }
            else if (columnaActual > 458)
            {
                casillaActual = "R" +
                Convert.ToChar('A' + columnaActual - 458) +
                (filaActual + 1);
            }
            else if (columnaActual > 484)
            {
                casillaActual = "S" +
                Convert.ToChar('A' + columnaActual - 484) +
                (filaActual + 1);
            }
            else if (columnaActual > 510)
            {
                casillaActual = "T" +
                Convert.ToChar('A' + columnaActual - 510) +
                (filaActual + 1);
            }
            else if (columnaActual > 536)
            {
                casillaActual = "U" +
                Convert.ToChar('A' + columnaActual - 536) +
                (filaActual + 1);
            }
            else if (columnaActual > 562)
            {
                casillaActual = "V" +
                Convert.ToChar('A' + columnaActual - 562) +
                (filaActual + 1);
            }
            else if (columnaActual > 588)
            {
                casillaActual = "W" +
                Convert.ToChar('A' + columnaActual - 588) +
                (filaActual + 1);
            }
            else if (columnaActual > 614)
            {
                casillaActual = "X" +
                Convert.ToChar('A' + columnaActual - 614) +
                (filaActual + 1);
            }
            else if (columnaActual > 640)
            {
                casillaActual = "Y" +
                Convert.ToChar('A' + columnaActual - 640) +
                (filaActual + 1);
            }
            else if (columnaActual > 666)
            {
                casillaActual = "Z" +
                Convert.ToChar('A' + columnaActual - 666) +
                (filaActual + 1);
            }
            else if (columnaActual <= 26)
            {
                casillaActual = "" +
            ...
            for (char columna = 'A'; columna <= 'Z'; columna++)
            {
            ...
            for (char columna = 'A'; columna <= 'Z'; columna++)
            {
                Escribir(3 + (26 + columna - 'A') * 9, 2,
                    AlinearIzquierda("A" + columna + "", 9), "inv");
            }

            for (char columna = 'A'; columna <= 'Z'; columna++)
            {
                Escribir(3 + (52 + columna - 'A') * 9, 2,
                    AlinearIzquierda("B" + columna + "", 9), "inv");
            }

            for (char columna = 'A'; columna <= 'Z'; columna++)
            {
                Escribir(3 + (78 + columna - 'A') * 9, 2,
                    AlinearIzquierda("C" + columna + "", 9), "inv");
            }

            for (char columna = 'A'; columna <= 'Z'; columna++)
            {
                Escribir(3 + (104 + columna - 'A') * 9, 2,
                    AlinearIzquierda("D" + columna + "", 9), "inv");
            }

            for (char columna = 'A'; columna <= 'Z'; columna++)
            {
                Escribir(3 + (130 + columna - 'A') * 9, 2,
                    AlinearIzquierda("E" + columna + "", 9), "inv");
            }

            for (char columna = 'A'; columna <= 'Z'; columna++)
            {
                Escribir(3 + (156 + columna - 'A') * 9, 2,
                    AlinearIzquierda("F" + columna + "", 9), "inv");
            }

            for (char columna = 'A'; columna <= 'Z'; columna++)
            {
                Escribir(3 + (182 + columna - 'A') * 9, 2,
                    AlinearIzquierda("G" + columna + "", 9), "inv");
            }

            for (char columna = 'A'; columna <= 'Z'; columna++)
            {
                Escribir(3 + (208 + columna - 'A') * 9, 2,
                    AlinearIzquierda("H" + columna + "", 9), "inv");
            }

            for (char columna = 'A'; columna <= 'Z'; columna++)
            {
                Escribir(3 + (234 + columna - 'A') * 9, 2,
                    AlinearIzquierda("I" + columna + "", 9), "inv");
            }

            for (char columna = 'A'; columna <= 'Z'; columna++)
            {
                Escribir(3 + (260 + columna - 'A') * 9, 2,
                    AlinearIzquierda("J" + columna + "", 9), "inv");
            }

            for (char columna = 'A'; columna <= 'Z'; columna++)
            {
                Escribir(3 + (286 + columna - 'A') * 9, 2,
                    AlinearIzquierda("K" + columna + "", 9), "inv");
            }

            for (char columna = 'A'; columna <= 'Z'; columna++)
            {
                Escribir(3 + (312 + columna - 'A') * 9, 2,
                    AlinearIzquierda("L" + columna + "", 9), "inv");
            }

            for (char columna = 'A'; columna <= 'Z'; columna++)
            {
                Escribir(3 + (338 + columna - 'A') * 9, 2,
                    AlinearIzquierda("M" + columna + "", 9), "inv");
            }

            for (char columna = 'A'; columna <= 'Z'; columna++)
            {
                Escribir(3 + (364 + columna - 'A') * 9, 2,
                    AlinearIzquierda("N" + columna + "", 9), "inv");
            }

            for (char columna = 'A'; columna <= 'Z'; columna++)
            {
                Escribir(3 + (380 + columna - 'A') * 9, 2,
                    AlinearIzquierda("O" + columna + "", 9), "inv");
            }

            for (char columna = 'A'; columna <= 'Z'; columna++)
            {
                Escribir(3 + (406 + columna - 'A') * 9, 2,
                    AlinearIzquierda("P" + columna + "", 9), "inv");
            }

            for (char columna = 'A'; columna <= 'Z'; columna++)
            {
                Escribir(3 + (432 + columna - 'A') * 9, 2,
                    AlinearIzquierda("Q" + columna + "", 9), "inv");
            }

            for (char columna = 'A'; columna <= 'Z'; columna++)
            {
                Escribir(3 + (458 + columna - 'A') * 9, 2,
                    AlinearIzquierda("R" + columna + "", 9), "inv");
            }

            for (char columna = 'A'; columna <= 'Z'; columna++)
            {
                Escribir(3 + (484 + columna - 'A') * 9, 2,
                    AlinearIzquierda("S" + columna + "", 9), "inv");
            }

            for (char columna = 'A'; columna <= 'Z'; columna++)
            {
                Escribir(3 + (510 + columna - 'A') * 9, 2,
                    AlinearIzquierda("T" + columna + "", 9), "inv");
            }

            for (char columna = 'A'; columna <= 'Z'; columna++)
            {
                Escribir(3 + (536 + columna - 'A') * 9, 2,
                    AlinearIzquierda("U" + columna + "", 9), "inv");
            }

            for (char columna = 'A'; columna <= 'Z'; columna++)
            {
                Escribir(3 + (562 + columna - 'A') * 9, 2,
                    AlinearIzquierda("V" + columna + "", 9), "inv");
            }

            for (char columna = 'A'; columna <= 'Z'; columna++)
            {
                Escribir(3 + (588 + columna - 'A') * 9, 2,
                    AlinearIzquierda("W" + columna + "", 9), "inv");
            }

            for (char columna = 'A'; columna <= 'Z'; columna++)
            {
                Escribir(3 + (614 + columna - 'A') * 9, 2,
                    AlinearIzquierda("X" + columna + "", 9), "inv");
            }

            for (char columna = 'A'; columna <= 'Z'; columna++)
            {
                Escribir(3 + (640 + columna - 'A') * 9, 2,
                    AlinearIzquierda("Y" + columna + "", 9), "inv");
            }

            for (char columna = 'A'; columna <= 'Z'; columna++)
            {
                Escribir(3 + (666 + columna - 'A') * 9, 2,
                    AlinearIzquierda("Z" + columna + "", 9), "inv");
            }
            ...
            try
            {
                ...
                for (int fila2 = 0; fila2 <= 999; fila2++)
                {
                    Escribir(0, fila2 + 2, AlinearDerecha(fila2, 3), "inv");

                    for (int columna = 0; columna < 692; columna++)
                    {
                        Escribir(3 + columna * 9, fila2 + 3,
                            datos[columna, fila2].nombre);
                    }
